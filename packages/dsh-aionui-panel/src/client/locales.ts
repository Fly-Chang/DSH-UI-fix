...
const zh = {
  ...
  'explorer.menu.copied': '已复制路径',
  'explorer.menu.revealInOs': '在文件管理器中显示',
  'explorer.menu.refresh': '刷新目录',
  'explorer.tree.emptyDir': '（空目录）',
  ...
  'scm.commit': '提交',
  'scm.committing': '提交中…',
  'scm.commitPlaceholder': '提交信息（Enter 提交）',
  'scm.commitEmpty': '提交信息不能为空',
  ...
  'preview.imageZoomHint': '点击图片放大查看',
  'preview.applyPatch': '应用补丁',
  'preview.patchApplying': '应用中…',
  'preview.patchApplied': '补丁已应用',
  'common.cancel': '取消',
  'common.confirm': '确定',
  'common.close': '关闭',
  'common.delete': '删除',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'explorer.menu.copied': 'Path copied',
  'explorer.menu.revealInOs': 'Reveal in file manager',
  'explorer.menu.refresh': 'Refresh directory',
  'explorer.tree.emptyDir': '(empty directory)',
  ...
  'scm.commitPlaceholder': 'Commit message (Enter to commit)',
  'scm.commitEmpty': 'Commit message must not be empty',
  ...
  'preview.imageZoomHint': 'Click the image to zoom',
  'preview.applyPatch': 'Apply patch',
  'preview.patchApplying': 'Applying…',
  'preview.patchApplied': 'Patch applied',
