...
export const zh = {
  ...
  'pet.state.error': '宠物走丢了（连接失败）',
  // 插件设置卡片（settings.plugin.item 席位）。
  'settings.title': '宠物',
  'settings.description': '宠物的显示布局与名字。',
...
export const en = {
  ...
  'settings.title': 'Pet',
  'settings.description': 'The pet\u2019s display layout and name.',
