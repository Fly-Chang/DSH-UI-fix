window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:F:\AI_worker\Model_dsh\plugins\dsh-web-ui\shared\motion.module.css.mjs
		const css$1 = ":root{--dsw-motion-instant:60ms;--dsw-motion-fast:.12s;--dsw-motion-base:.18s;--dsw-motion-slow:.26s;--dsw-motion-gentle:.4s;--dsw-motion-ease:cubic-bezier(.4, 0, .2, 1);--dsw-motion-ease-in:cubic-bezier(.4, 0, 1, 1);--dsw-motion-ease-out:cubic-bezier(0, 0, .2, 1);--dsw-motion-spring:cubic-bezier(.34, 1.12, .5, 1)}@media (prefers-reduced-motion:reduce){:root{--dsw-motion-instant:0s;--dsw-motion-fast:0s;--dsw-motion-base:0s;--dsw-motion-slow:0s;--dsw-motion-gentle:0s}}";
		const tagId$1 = "@linxin666/dsh-client-ui-skin-center/motion.module.css";
		...
		const SKIN_CENTER_ENTRIES = [
			...
			},
			{
				...
				"nameEn": "Phrolova",
				"author": "dsh-web-ui",
				"tagline": "紫海暮色 · 夜玫微光 · 亮暗双面角色主题",
				"description": "弗洛洛 — 一面是暮色下的紫色花海（粉紫丁香色调，花瓣飘落），一面是黑紫暗夜里一朵发光的红玫瑰（红黑哥特氛围）。亮暗主题各自配一幅插画背景与一枚玫瑰 favicon，面板半透明磨砂，让画面透出来，玫瑰红是整套皮肤的点睛色。",
				"tags": [
					"phrolova",
					"anime",
					"wuthering-waves",
				...
				"accent": "#c03048",
				"bodyAttr": "data-dsh-phrolova",
				"package": "@linxin666/dsh-client-ui-skin-phrolova",
				"order": 10
			}
		];
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:F:\AI_worker\Model_dsh\plugins\dsh-web-ui\packages\skins\skin-center\src\client\skin-center.module.css.mjs
		const css = "body[data-dsh-skin-center] .bOgS6W_pluginCard{border:1px solid var(--dsw-alias-border-l1,#e2e8f0);background:var(--dsw-alias-bg-layer-2,#fff);border-radius:8px;list-style:none;overflow:hidden}body[data-dsh-skin-center] .bOgS6W_cardHeader{width:100%;color:inherit;font:inherit;text-align:left;cursor:pointer;transition:background var(--dsw-motion-fast) var(--dsw-motion-ease);background:0 0;border:0;align-items:center;padding:11px 14px;display:flex}body[data-dsh-skin-center] .bOgS6W_cardHeader:hover{background:var(--dsw-alias-bg-layer-1,#f1f5f9)}body[data-dsh-skin-center] .bOgS6W_cardHeader:active{background:var(--dsw-alias-bg-layer-3,#e6ecf4)}body[data-dsh-skin-center] .bOgS6W_cardHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#2b7cd9);outline-offset:2px}body[data-dsh-skin-center] .bOgS6W_headText{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}body[data-dsh-skin-center] .bOgS6W_pluginName{color:var(--dsw-alias-label-primary,#172a45);align-items:baseline;gap:8px;font-size:13.5px;font-weight:600;display:flex}body[data-dsh-skin-center] .bOgS6W_cardDescription{color:var(--dsw-alias-label-secondary,#6b7280);font-size:12px;line-height:1.4}body[data-dsh-skin-center] .bOgS6W_chevron,body[data-dsh-skin-center] .bOgS6W_chevronOpen{color:var(--dsw-alias-label-secondary,#6b7280);transition:transform var(--dsw-motion-fast) var(--dsw-motion-ease);flex:none;margin-left:10px;font-size:12px}body[data-dsh-skin-center] .bOgS6W_chevronOpen{transform:rotate(180deg)}body[data-dsh-skin-center] .bOgS6W_cardBody{border-top:1px solid var(--dsw-alias-border-l1,#e2e8f0);flex-direction:column;gap:12px;padding:12px 14px 14px;display:flex}body[data-dsh-skin-center] .bOgS6W_head{flex-direction:column;gap:6px;display:flex}body[data-dsh-skin-center] .bOgS6W_titleBadge{color:var(--dsw-alias-label-secondary,#6b7280);font-size:11px;font-weight:500}body[data-dsh-skin-center] .bOgS6W_intro{color:var(--dsw-alias-label-secondary,#6b7280);font-size:12.5px;line-height:1.55}body[data-dsh-skin-center] .bOgS6W_themeRow{align-items:center;gap:8px;margin-top:2px;display:flex}body[data-dsh-skin-center] .bOgS6W_themeLabel{color:var(--dsw-alias-label-secondary,#6b7280);margin-right:2px;font-size:12px}body[data-dsh-skin-center] .bOgS6W_themeButton{border:1px solid var(--dsw-alias-border-l3,#cbd5e1);background:var(--dsw-alias-bg-layer-2,#fff);color:var(--dsw-alias-label-primary,#172a45);cursor:pointer;transition:background var(--dsw-motion-fast) var(--dsw-motion-ease), border-color var(--dsw-motion-fast) var(--dsw-motion-ease), color var(--dsw-motion-fast) var(--dsw-motion-ease), transform var(--dsw-motion-fast) var(--dsw-motion-ease);border-radius:6px;padding:5px 10px;font-size:12px;line-height:1}body[data-dsh-skin-center] .bOgS6W_themeButton:hover{border-color:var(--dsw-alias-border-l4,#94a3b8)}body[data-dsh-skin-center] .bOgS6W_themeButton:active{border-color:var(--dsw-alias-brand-primary,#2b7cd9);background:var(--dsw-alias-button-primary-dimmed,#e8f1fc);color:var(--dsw-alias-brand-primary,#1e63b8);transform:scale(.96)}body[data-dsh-skin-center] .bOgS6W_themeButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#2b7cd9);outline-offset:2px}body[data-dsh-skin-center] .bOgS6W_themeButtonActive{border-color:var(--dsw-alias-brand-primary,#2b7cd9);background:var(--dsw-alias-button-primary-dimmed,#e8f1fc);color:var(--dsw-alias-brand-primary,#1e63b8)}body[data-dsh-skin-center] .bOgS6W_list{flex-direction:column;gap:10px;display:flex}body[data-dsh-skin-center] .bOgS6W_card{border:1px solid var(--dsw-alias-border-l1,#e2e8f0);background:var(--dsw-alias-bg-layer-2,#fff);transition:transform var(--dsw-motion-fast) var(--dsw-motion-ease);border-radius:10px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}body[data-dsh-skin-center] .bOgS6W_card:hover{transform:translateY(-2px)}body[data-dsh-skin-center] .bOgS6W_card:active{transform:scale(.98)}body[data-dsh-skin-center] .bOgS6W_cardHead{align-items:center;gap:10px;min-width:0;display:flex}body[data-dsh-skin-center] .bOgS6W_swatch{width:14px;height:14px;box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l4,#0f172a1f);border-radius:50%;flex:none}body[data-dsh-skin-center] .bOgS6W_cardName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13.5px;font-weight:600;overflow:hidden}body[data-dsh-skin-center] .bOgS6W_cardTagline{color:var(--dsw-alias-label-secondary,#6b7280);font-size:12px;line-height:1.45}body[data-dsh-skin-center] .bOgS6W_badge{letter-spacing:.02em;border-radius:999px;flex:none;min-width:0;margin-left:auto;padding:2px 8px;font-size:11px;font-weight:600}body[data-dsh-skin-center] .bOgS6W_badgeActive{color:var(--dsw-alias-state-success-primary,#0f6b3a);background:var(--dsw-alias-state-success-tertiary,#dcf3e5)}body[data-dsh-skin-center] .bOgS6W_badgeTrying{color:var(--dsw-alias-brand-primary,#1e63b8);background:var(--dsw-alias-button-primary-dimmed,#e2edfc)}body[data-dsh-skin-center] .bOgS6W_actions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}body[data-dsh-skin-center] .bOgS6W_button{border:1px solid var(--dsw-alias-border-l3,#cbd5e1);background:var(--dsw-alias-bg-layer-2,#fff);color:var(--dsw-alias-label-primary,#172a45);cursor:pointer;transition:background var(--dsw-motion-fast) var(--dsw-motion-ease), border-color var(--dsw-motion-fast) var(--dsw-motion-ease), color var(--dsw-motion-fast) var(--dsw-motion-ease), transform var(--dsw-motion-fast) var(--dsw-motion-ease);border-radius:7px;padding:6px 12px;font-size:12px;line-height:1}body[data-dsh-skin-center] .bOgS6W_button:hover:not(:disabled){border-color:var(--dsw-alias-brand-primary,#2b7cd9);color:var(--dsw-alias-brand-primary,#1e63b8)}body[data-dsh-skin-center] .bOgS6W_button:active:not(:disabled){border-color:var(--dsw-alias-button-primary-hover,#1e63b8);background:var(--dsw-alias-button-primary-dimmed,#e8f1fc);color:var(--dsw-alias-brand-primary,#1e63b8);transform:scale(.96)}body[data-dsh-skin-center] .bOgS6W_button:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#2b7cd9);outline-offset:2px}body[data-dsh-skin-center] .bOgS6W_buttonPrimary{border-color:var(--dsw-alias-brand-primary,#2b7cd9);background:var(--dsw-alias-button-primary-fill,#2b7cd9);color:var(--dsw-alias-label-primary-foreground,#fff)}body[data-dsh-skin-center] .bOgS6W_buttonPrimary:hover:not(:disabled){border-color:var(--dsw-alias-button-primary-hover,#1e63b8);background:var(--dsw-alias-button-primary-hover,#1e63b8);color:var(--dsw-alias-label-primary-foreground,#fff)}body[data-dsh-skin-center] .bOgS6W_buttonPrimary:active:not(:disabled),body[data-dsh-skin-center] .bOgS6W_buttonPrimary:focus-visible:not(:disabled){border-color:var(--dsw-alias-button-primary-hover,#1e63b8);background:var(--dsw-alias-button-primary-hover,#1e63b8)}body[data-dsh-skin-center] .bOgS6W_buttonGhost{background:0 0;border-color:#0000}body[data-dsh-skin-center] .bOgS6W_button:disabled{opacity:.55;cursor:default}body[data-dsh-skin-center] .bOgS6W_error{color:var(--dsw-alias-state-error-primary,#b42318);font-size:12px}body[data-dsh-skin-center] .bOgS6W_backgroundRow{flex-direction:column;gap:6px;padding:8px 0;display:flex}body[data-dsh-skin-center] .bOgS6W_backgroundHead{align-items:center;gap:8px;display:flex}body[data-dsh-skin-center] .bOgS6W_backgroundLabel{color:var(--dsw-alias-label-primary,#172a45);font-size:12.5px;font-weight:600}body[data-dsh-skin-center] .bOgS6W_backgroundValue{font-variant-numeric:tabular-nums;color:var(--dsw-alias-brand-primary,#2b7cd9);flex:none;margin-left:auto;font-size:12px}body[data-dsh-skin-center] .bOgS6W_backgroundRange{background:var(--dsw-alias-bg-layer-3,#e2e8f0);-webkit-appearance:none;appearance:none;cursor:pointer;border-radius:999px;width:100%;height:4px;margin:0}body[data-dsh-skin-center] .bOgS6W_backgroundRange::-webkit-slider-thumb{-webkit-appearance:none;appearance:none;border:2px solid var(--dsw-alias-label-primary-foreground,#fff);background:var(--dsw-alias-brand-primary,#2b7cd9);width:14px;height:14px;box-shadow:0 0 0 1px var(--dsw-alias-border-l4,#0f172a1f);cursor:pointer;border-radius:50%}body[data-dsh-skin-center] .bOgS6W_backgroundRange::-moz-range-thumb{border:2px solid var(--dsw-alias-label-primary-foreground,#fff);background:var(--dsw-alias-brand-primary,#2b7cd9);width:12px;height:12px;box-shadow:0 0 0 1px var(--dsw-alias-border-l4,#0f172a1f);cursor:pointer;border-radius:50%}body[data-dsh-skin-center] .bOgS6W_backgroundRange:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#2b7cd9);outline-offset:2px}body[data-dsh-skin-center] .bOgS6W_backgroundHint{color:var(--dsw-alias-label-secondary,#6b7280);font-size:12px;line-height:1.5}body[data-dsh-skin-center] .bOgS6W_backgroundHintMuted{color:var(--dsw-alias-label-tertiary,#9aa4b5);font-size:12px;line-height:1.5}@media (prefers-reduced-motion:reduce){body[data-dsh-skin-center] .bOgS6W_cardHeader,body[data-dsh-skin-center] .bOgS6W_themeButton,body[data-dsh-skin-center] .bOgS6W_button,body[data-dsh-skin-center] .bOgS6W_chevron,body[data-dsh-skin-center] .bOgS6W_chevronOpen{transition:none}}";
		...
		var skin_center_module_css_default = {
			"actions": "bOgS6W_actions",
			"backgroundHead": "bOgS6W_backgroundHead",
			"backgroundHint": "bOgS6W_backgroundHint",
			"backgroundHintMuted": "bOgS6W_backgroundHintMuted",
			"backgroundLabel": "bOgS6W_backgroundLabel",
			"backgroundRange": "bOgS6W_backgroundRange",
			"backgroundRow": "bOgS6W_backgroundRow",
			"backgroundValue": "bOgS6W_backgroundValue",
			"badge": "bOgS6W_badge",
			"badgeActive": "bOgS6W_badgeActive",
			"badgeTrying": "bOgS6W_badgeTrying",
			"button": "bOgS6W_button",
			"buttonGhost": "bOgS6W_buttonGhost",
			"buttonPrimary": "bOgS6W_buttonPrimary",
			"card": "bOgS6W_card",
			"cardBody": "bOgS6W_cardBody",
			"cardDescription": "bOgS6W_cardDescription",
			"cardHead": "bOgS6W_cardHead",
			"cardHeader": "bOgS6W_cardHeader",
			"cardName": "bOgS6W_cardName",
			"cardTagline": "bOgS6W_cardTagline",
			"chevron": "bOgS6W_chevron",
			"chevronOpen": "bOgS6W_chevronOpen",
			"error": "bOgS6W_error",
			"head": "bOgS6W_head",
			"headText": "bOgS6W_headText",
			"intro": "bOgS6W_intro",
			"list": "bOgS6W_list",
			"pluginCard": "bOgS6W_pluginCard",
			"pluginName": "bOgS6W_pluginName",
			"swatch": "bOgS6W_swatch",
			"themeButton": "bOgS6W_themeButton",
			"themeButtonActive": "bOgS6W_themeButtonActive",
			"themeLabel": "bOgS6W_themeLabel",
			"themeRow": "bOgS6W_themeRow",
			"titleBadge": "bOgS6W_titleBadge"
		};
		//#endregion
