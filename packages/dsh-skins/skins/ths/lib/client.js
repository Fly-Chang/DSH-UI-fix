window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var ths_module_css_default = {
			"aionPreviewIn": "ROWUZG_aionPreviewIn",
			"thsStatusbar": "ROWUZG_thsStatusbar",
			"thsStatusbarCell": "ROWUZG_thsStatusbarCell",
			"thsStatusbarSpacer": "ROWUZG_thsStatusbarSpacer",
			"thsTitlebar": "ROWUZG_thsTitlebar",
			"thsTitlebarBtn": "ROWUZG_thsTitlebarBtn",
			"thsTitlebarIcon": "ROWUZG_thsTitlebarIcon",
			"thsTitlebarTicker": "ROWUZG_thsTitlebarTicker",
			"thsTitlebarTickerChg": "ROWUZG_thsTitlebarTickerChg",
			"thsTitlebarTickerVal": "ROWUZG_thsTitlebarTickerVal",
			"thsTitlebarTitle": "ROWUZG_thsTitlebarTitle"
		};
		//#endregion
